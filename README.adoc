...
A library for reading, deleting, moving and writing a file on the
File System using Enonic XP.
...
....
dependencies {
    include 'no.rbrastad.enonic.lib:filesystem:0.9.5'
}
....
...
See test cases for other examples: https://github.com/rbrastad/lib-filesystem/blob/master/src/test/resources/lib/rbrastad/file-system/file-system-test.js[]
